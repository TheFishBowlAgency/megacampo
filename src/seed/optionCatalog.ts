import type { ActivityDef, CategoryDef, OptionDef, OptionGroupDef } from "./helpers";

export const ACTIVITIES: ActivityDef[] = [
  { key: "paintball", title: "Paintball", sort: 1 },
  { key: "soft-paintball", title: "Soft Paintball", sort: 2 },
  { key: "mini-paintball", title: "Mini Paintball", sort: 3 },
  { key: "airsoft", title: "Airsoft", sort: 4 },
  { key: "laser-tag", title: "Laser Tag", sort: 5 },
  { key: "multi-activities", title: "Multi-Activities", sort: 6 },
];
...
export const OPTIONS: OptionDef[] = [
  { key: "paintballs:200", groupKey: "paintballs", label: "200 Paintballs", sort: 1 },
  { key: "paintballs:500", groupKey: "paintballs", label: "500 Paintballs", sort: 2 },
  { key: "paintballs:1000", groupKey: "paintballs", label: "1000 Paintballs", sort: 3 },
  { key: "paintballs:unlimited", groupKey: "paintballs", label: "Unlimited", sort: 4 },
  { key: "paintballs:80", groupKey: "paintballs", label: "80 Paintballs", sort: 5 },
  { key: "paintballs:250", groupKey: "paintballs", label: "250 Paintballs", sort: 6 },

  { key: "apparel:not-included", groupKey: "apparel", label: "Not Included", sort: 1 },
  { key: "apparel:vest", groupKey: "apparel", label: "Vest", sort: 2 },
  { key: "apparel:camo-overalls", groupKey: "apparel", label: "Cammo Overalls", sort: 3 },
  {
  ...
  { key: "marker:classic", groupKey: "marker", label: "Classic Marker", sort: 1 },
  { key: "marker:pro", groupKey: "marker", label: "Pro Marker", sort: 2 },

  { key: "goggles:classic", groupKey: "goggles", label: "Classic Goggles", sort: 1 },
  { key: "goggles:pro", groupKey: "goggles", label: "Pro Goggles", sort: 2 },
  { key: "goggles:not-included", groupKey: "goggles", label: "Not Included", sort: 3 },
  { key: "goggles:classic-lowercase", groupKey: "goggles", label: "Classic goggles", sort: 4 },
  { key: "goggles:pro-lowercase", groupKey: "goggles", label: "Pro goggles", sort: 5 },

  { key: "gloves:not-included", groupKey: "gloves", label: "Not Included", sort: 1 },
  { key: "gloves:gloves", groupKey: "gloves", label: "Gloves", sort: 2 },

  { key: "meal:not-included", groupKey: "meal", label: "Not Included", sort: 1 },
  {
  ...
  { key: "meal:snack", groupKey: "meal", label: "Snack", sort: 4, defaultPriceEur: 9.95 },
  ...
  { key: "activity-count:4", groupKey: "activity-count", label: "4 Activities", sort: 1 },
  { key: "activity-count:5", groupKey: "activity-count", label: "5 Activities", sort: 2 },
  { key: "activity-count:6", groupKey: "activity-count", label: "6 Activities", sort: 3 },
];
